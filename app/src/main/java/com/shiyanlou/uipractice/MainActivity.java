...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText editeText_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editeText_name = (EditText)findViewById(R.id.editText_name);
        button_showName = (Button)findViewById(R.id.button_showName);
        textView_content = (TextView)findViewById(R.id.textViewContent);

        button_showName.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String name = editeText_name.getText().toString();
